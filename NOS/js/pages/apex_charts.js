...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#04518c", "#51ce8a", "#733aeb", "#f2426d", "#fec801"],
		tooltip: {
			y: {
				formatter: function(val) {
					return val + "K"
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#51ce8a", "#04518c", "#f2426d", "#fec801"],
		series: [44, 55, 13, 33]
	}
	var chart = new ApexCharts(
