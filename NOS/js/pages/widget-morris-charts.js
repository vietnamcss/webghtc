...
$(function () {
    ...
    Morris.Area({
        ...
        pointSize: 3,
        fillOpacity: 0,
        pointStrokeColors:['#04518c', '#51ce8a', '#733aeb'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 3,
        hideHover: 'auto',
        lineColors: ['#04518c', '#51ce8a', '#733aeb'],
        resize: true
...
Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: 0.4,
        pointStrokeColors:['#f2426d', '#04518c'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 0,
        smooth: false,
        hideHover: 'auto',
        lineColors: ['#f2426d', '#04518c'],
        resize: true
...
// bar chart
    Morris.Bar({
        ...
        ykeys: ['a', 'b', 'c'],
        labels: ['A', 'B', 'C'],
        barColors:['#fec801', '#04518c', '#51ce8a'],
        hideHover: 'auto',
        gridLineColor: '#eef0f2',
        resize: true
    });
// area chart
 Morris.Area({
        ...
        data: [{
                ...
                lineColors: ['#04518c', '#f2426d', '#fec801'],
                xkey: 'period',
                ykeys: ['data1', 'data2', 'data3'],
                labels: ['Data 1', 'Data 2', 'Data 3'],
                pointSize: 0,
